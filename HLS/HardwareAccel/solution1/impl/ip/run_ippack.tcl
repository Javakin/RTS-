...
set IPName      "HWAccel"
set Version     "1.0"
set DisplayName "Hwaccel"
set Revision    "1806112342"
...
set Interfaces {
    s_axi_AXI_L {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_AXI_L"
        param_prefix "C_S_AXI_AXI_L"
        addr_bits "6"
        ...
        memories "s_screen_val {base_address 16 range 16} s_mask_val {base_address 32 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 8 machine 64 combinational 0 latency 7 II x}
