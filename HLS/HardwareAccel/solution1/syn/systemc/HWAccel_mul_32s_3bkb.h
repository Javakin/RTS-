...
#ifndef __HWAccel_mul_32s_3bkb__HH__
#define __HWAccel_mul_32s_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(HWAccel_mul_32s_3bkb) {
    ...
    SC_CTOR(HWAccel_mul_32s_3bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
