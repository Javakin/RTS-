...
HD_PWD='D:/Smartgit/RTS-/TestProject/Hello_World/Hello_World.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_first_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Design_first_wrapper.tcl -notrace
