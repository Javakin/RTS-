...
HD_PWD='D:/Smartgit/RTS-/TestProject/Hello_World/Hello_World.runs/Design_first_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_first_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Design_first_processing_system7_0_0.tcl
