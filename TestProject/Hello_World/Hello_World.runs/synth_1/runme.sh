...
HD_PWD='D:/Smartgit/RTS-/TestProject/Hello_World/Hello_World.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_first_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Design_first_wrapper.tcl
