...
--Date        : Sat Jun  9 14:16:04 2018
--Host        : DESKTOP-2CB2V6S running 64-bit major release  (build 9200)
--Command     : generate_target Design_first.bd
--Design      : Design_first
...
entity Design_first is
  ...
  attribute CORE_GENERATION_INFO of Design_first : entity is "Design_first,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Design_first,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=2,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of Design_first : entity is "Design_first.hwdef";
end Design_first;

architecture STRUCTURE of Design_first is
  component Design_first_processing_system7_0_1 is
  port (
  ...
  end component Design_first_processing_system7_0_1;
...
begin
processing_system7_0: component Design_first_processing_system7_0_1
     port map (
